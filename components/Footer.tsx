            ...
            <div className="md:col-span-4">
              ...
              <div className="mt-4 rounded-xl border border-white/10 bg-white/5 p-4">
                ...
                <dl className="grid grid-cols-2 gap-y-1 text-sm text-gray-300">
                  <dt>Monday</dt><dd className="text-right">12:00pm – 11:30pm</dd>
                  <dt>Tuesday</dt><dd className="text-right">04:00pm – 09:00pm</dd>
                  <dt>Wednesday</dt><dd className="text-right">05:00pm – 10:00pm</dd>
                  <dt>Thursday</dt><dd className="text-right">02:00pm – 10:00pm</dd>
                  <dt>Friday</dt><dd className="text-right">11:00am – 12:00am</dd>
                  <dt>Saturday</dt><dd className="text-right">11:00am – 12:00am</dd>
                  <dt>Sunday</dt><dd className="text-right">11:00am – 10:00pm</dd>
                </dl>
              </div>
            </div>
